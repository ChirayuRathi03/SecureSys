...
# Task 1.2.1.4: Ensure package manager repositories are configured (Manual)

# Task 1.2.2.1: Ensure updates, patches, and additional security software are installed
dnf update
...
# Task 1.3.1.6: Ensure no unconfined services exist (Manual)

# Task 1.3.1.7: Ensure the MCS Translation Service (mcstrans) is not installed
dnf remove mcstrans -y

# Task 1.3.1.8: Ensure the SETroubleshoot is not installed
