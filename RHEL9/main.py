...
module_names = {
    ...
    8: "Database and Web Server Hardening"
}
...
if mode == 1:
    ...
    bash = ['Module1.sh', 'Module2.sh', 'Module3.sh', 'Module4.sh', 'Module5.sh', 'Module6.sh', 'Module7.sh', 'Module8.sh']
    pyth = ['Module1.py', 'Module2.py', 'Module3.py', 'Module4.py', 'Module5.py', 'Module6.py', 'Module7.py']
    for x in bash:
    ...
    print("     3. Network (Network devices, Kernel Modules, Kernel parameters)")
    print("     4. Host based firewall (firewalld, nftables)")
    print("     5. Access Control (SSH server, Privilege Escalation, PAM, Authselect, User Accounts)")
    print("     6. Logging and Auditing (systemd-journal, journald, rsyslog, Log Files, auditd, Data Retention)")
    print("     7. System Maintainence (System File Permissions, User and Group Settings)")
    print("     8. Database and Web Server Hardening")
    ...
    os.system('clear')
    os.system('python BasicConfig.py')
